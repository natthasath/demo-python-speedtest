...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.label_1 = customtkinter.CTkLabel(master=self.frame_left, text="SpeedTest")
        ...
        self.label_info_1 = customtkinter.CTkLabel(master=self.frame_info, text="Speed Test", height=80, fg_color=("white", "gray38"), justify=tkinter.LEFT)
        self.label_info_1.grid(column=0, row=0, sticky="we", padx=15, pady=15)

        self.button_5 = customtkinter.CTkButton(master=self.frame_right, text="Test", command=self.test)
    ...
    def foo(self):
        ...
        self.label_info_1 = customtkinter.CTkLabel(master=self.frame_info, text="Testing", height=80, fg_color=("white", "gray38"), justify=tkinter.LEFT)
        self.label_info_1.grid(column=0, row=0, sticky="we", padx=15, pady=15)
        ...
        self.label_info_1 = customtkinter.CTkLabel(master=self.frame_info, text="\n\tResult\n\nWrite Speed: {:.2f} MB/s\n\n".format(results['Write Speed']) + "Read Speed: {:.2f} MB/S\n".format(results['Read Speed']), height=80, fg_color=("white", "gray38"), justify=tkinter.LEFT)
        self.label_info_1.grid(column=0, row=0, sticky="we", padx=15, pady=15)
